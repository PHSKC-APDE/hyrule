...
4.  Decide how you will want to generate your first training dataset. I recommend using a prefit model (either on fake data or a model fit by a colleague-- ask Daniel about this second option)
